...
```bash
node "/Users/joffy/Site/get-shit-done-ev/.claude/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/Users/joffy/Site/get-shit-done-ev/.claude/get-shit-done/bin/gsd-tools.cjs" validate health
```
